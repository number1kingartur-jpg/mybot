...
export const FOODS: FoodItem[] = [
  ...
  // UHT 3.7% из 7-Eleven/Tops и российское 3.2% из пакета: жир и тара разные,
  // одно «молоко» на оба врёт и по цифрам, и по кадру.
  { aliases: ["молок", "milk", "тайское молоко", "молоко тайское", "молоко uht", "uht milk", "thai milk"], name: "Молоко таиландское", kcal100: 64, p100: 3.2, f100: 3.7, c100: 4.8, defaultG: 200, category: "other", densityGml: 1.03, tbspG: 15, minG: 20 },
  { aliases: ["молоко российское", "российское молоко", "молоко 3.2", "молоко 3,2"], name: "Молоко российское", kcal100: 60, p100: 3, f100: 3.2, c100: 4.7, defaultG: 200, category: "other", densityGml: 1.03, tbspG: 15, minG: 20 },
  ...
  { aliases: ["foremost", "фомост"], name: "Foremost", kcal100: 64, p100: 3.2, f100: 3.7, c100: 4.8, defaultG: 200, category: "other", densityGml: 1.03, pieceG: 200, minG: 50, brand: true, variantOf: "Молоко таиландское" },
  ...
  { aliases: ["meiji", "мейджи"], name: "Meiji", kcal100: 64, p100: 3.2, f100: 3.4, c100: 4.8, defaultG: 200, category: "other", densityGml: 1.03, pieceG: 200, minG: 50, brand: true, variantOf: "Молоко таиландское" },
  ...
  { aliases: ["простоквашино", "prostokvashino"], name: "Простоквашино", kcal100: 60, p100: 3, f100: 3.2, c100: 4.7, defaultG: 200, category: "other", densityGml: 1.03, pieceG: 200, minG: 50, brand: true, variantOf: "Молоко российское" },
  { aliases: ["домик в деревне", "домик в деревне молоко"], name: "Домик в деревне", kcal100: 58, p100: 2.8, f100: 3.2, c100: 4.7, defaultG: 200, category: "other", densityGml: 1.03, pieceG: 200, minG: 50, brand: true, variantOf: "Молоко российское" },
...
export const STAPLE_ROLE: Record<string, FoodRole> = {
  ...
  "Йогурт": "protein",
  "Кефир": "protein",
  "Молоко таиландское": "protein",
  "Молоко российское": "protein",
  "Молоко 1.5%": "protein",
  "Протеин": "protein",
