...
export const IDENTIFY_PROMPT =
  ...
  "Целые яйца: посчитай штуки в кадре и напиши число, «2 яйца отварные», 110 г. " +
  "Не подставляй типичный завтрак из трёх, если в кадре два. " +
  "Яйца в скорлупе или на тарелке это яйца, не протеиновый напиток. " +
  "Омлет и яичница: число яиц пиши в названии, «омлет из 4 яиц». " +
  "Граммы готового: омлет число × 75, яичница число × 60. " +
  "Если в описании 4 яйца, не ставь 150 г по умолчанию. " +
  "Блины, оладьи, сырники: число штук в названии, «3 блина», «4 оладьи», «2 сырника». " +
  "Граммы: блин 50, оладья 35, сырник 60.\n" +
  ...
  "3.2% (бутылка, Простоквашино, Домик в деревне) это разные продукты. Назови " +
  "«молоко таиландское» или «молоко российское», не просто «молоко». " +
  "Марку, если видна, оставь как есть.\n" +
  "16. Кола и пепси: если на этикетке Zero, Diet, Light, Max, «без сахара» или 0 ккал, " +
  "назови «кола без сахара». Обычная кола с сахаром — «кола». Не путай их.\n" +
  "17. Салат с сухариками, гренками или крутонами это салат, не чипсы. Разложи: зелень, " +
  "овощи, яйцо, сухарики, соус. Чипсы — только если это пакет чипсов.\n" +
  "18. Картинка в дневнике берётся из названия. Называй готовое блюдо блюдом: " +
  "«курица на гриле», не просто «курица», если на кадре готовая тарелка.\n" +
  "19. Магазинная полка: 7-Eleven, Tops, Lotus, Big C, Макро, Магнит, Пятёрочка, " +
