...
export const IDENTIFY_PROMPT =
  ...
  "15. Кола и пепси: если на этикетке Zero, Diet, Light, Max, «без сахара» или 0 ккал, " +
  "назови «кола без сахара». Обычная кола с сахаром — «кола». Не путай их.\n" +
  "16. Салат с сухариками, гренками или крутонами это салат, не чипсы. Разложи: зелень, " +
